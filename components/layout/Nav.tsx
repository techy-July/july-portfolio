...
export default function Nav() {
  ...
  return (
    <nav className="sticky top-0 z-50 flex h-12 w-full items-center justify-between border-b border-grey-200 bg-[#FAF9F7] px-5 drop-shadow-sm">
      <Link
        href="/"
        className="font-serif text-[14px] text-grey-900 drop-shadow-md"
      >
